...
const Navbar = () => {
  ...
  return (
    <nav className=" bg-whitefixed bgimg w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600  bgimg">
      <div className=" flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2">
          ...
          <Image
            src={Monke1}
            alt=""
            className="h-12 w-12 mr-4 hidden sm:block"
          />
